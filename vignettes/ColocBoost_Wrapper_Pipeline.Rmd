...
- See more details about functions in the package `pecotmr` with [link](https://github.com/xueweic/pecotmr/tree/main) and 
`colocboost_pipeline` with [link](https://github.com/xueweic/pecotmr/blob/main/R/colocboost_pipeline.R). 
