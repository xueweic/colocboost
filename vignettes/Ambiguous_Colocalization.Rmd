...
if researcher decides to investigate these ambigous colocalization events. As such, the `colocboost_plot` function will not consider it as colocalized but still showing them as uncolocalized events,
with overlapping variants color labelled.  
