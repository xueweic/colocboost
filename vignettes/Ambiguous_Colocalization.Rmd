...
res <- get_ambiguous_colocalization(colocboost_results, min_abs_corr_between_ucos = 0.5, median_abs_corr_between_ucos = 0.8)
names(res)
...
summary_ambiguous <- full_summary$ambiguous_ucos_summary
