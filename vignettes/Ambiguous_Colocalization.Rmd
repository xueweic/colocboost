...
Note that the COLOC results are directly from two `susie` output objects (code provided below), 
not restricting the analysis to only the overlapping variants between GWAS and eQTL. 
