...
#### 3.5.1. Trait-specific (uncolocalized) traits (**`ucos`**)

- **`ucos`**: A list containing detailed information about trait-specific (uncolocalized) traits for each uCoS.
  - **`ucos_index`**: Indices of trait-specific (uncolocalized) variables.
  - **`ucos_variables`**: Names of trait-specific (uncolocalized) variables.
...
- **`ucos_outcomes`**: A list with detailed information about trait-specific (uncolocalized) outcomes for each uCoS.
...
providing additional insights into the dataset.
