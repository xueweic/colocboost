...
In this section, we will provide a brief overview of the components of interest for deepening into ColocBoost result.
...
### 4. Entire colocboost output (for advanced users)
...
In this section, we will provide a brief overview of each component and its contents.

#### 4.1. Variant colocalization probability (VCP)

- **`vcp`**: The variable colocalized probability for each variable.

#### 4.2. Colocalization details
